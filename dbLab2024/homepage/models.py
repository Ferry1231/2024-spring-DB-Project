...
class Students(models.Model):
    ...
    mentor_id = models.ForeignKey('Mentors',to_field='mentor_id',on_delete=models.RESTRICT,null=True)
...
class Grades(models.Model):
    cous_id = models.ForeignKey('Courses',to_field='cous_id',on_delete=models.RESTRICT,null=True)
    stu_id = models.ForeignKey('Students',to_field='stu_id',on_delete=models.RESTRICT,null=True)
...
class selectedMaterials(models.Model):
    matr_id = models.ForeignKey('Materials',to_field='matr_id',on_delete=models.RESTRICT,null=True)
    stu_id = models.ForeignKey('Students',to_field='stu_id',on_delete=models.RESTRICT,null=True)
